	...
	return (
		<Section class="vertical-spacing-150-percent" heading={headings.h2_1}>
			...
			<p class="vertical-spacing">
				...
				websites. The design files usually featured disperate layouts for mobile
				<span aria-hidden="true">📱</span>, tablet, and desktop
				<span aria-hidden="true">🖥</span>. To smooth out the layout jump at breakpoints I employed a technique I call
				responsify, which uses CSS <Code>calc()</Code> function to <em>fluidly</em> change
				<Code>width</Code>, <Code>margin</Code>, <Code>left</Code>, etc. so it matches the value at the neighboring
				breakpoint.
			</p>
