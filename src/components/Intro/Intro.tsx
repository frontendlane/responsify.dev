	...
	return (
		<Section className="vertical-spacing-150-percent" heading={headings.h2_1}>
			...
			<p className="vertical-spacing">
				...
				<Code>width</Code>, <Code>margin</Code>, <Code>left</Code>, etc. at breakpoints.
			</p>
			<p className="vertical-spacing">
				Many told me they didn&apos;t understand what <em>exactly</em> it does until they saw it in action.{' '}
