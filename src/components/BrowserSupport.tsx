	...
	return (
		<Section className="vertical-spacing-150-percent" heading={headings.h2_6}>
			<p className="vertical-spacing">
				...
				doesn&apos;t support. As far as &quot;exotic&quot; 🐠 CSS values go: <Code>vw</Code> is supported by all
				browsers and <Code>ch</Code> is narrower on IE compared to other browsers, so just look out for that.
			</p>
		</Section>
	)
}
